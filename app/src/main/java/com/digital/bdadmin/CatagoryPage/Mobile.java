...
public class Mobile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DailyInstumentDatabase = FirebaseDatabase.getInstance().getReference().child(DataManager.Mobile);
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Mobile.this);
                View Mview = LayoutInflater.from(Mobile.this).inflate(R.layout.input_subcatagory, null, false);
                ...
                insertbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (subcatagry.isEmpty()) {
                            ...
                            categorymap.put(DataManager.Type, DataManager.Mobile);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    catagoryHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                                        ...
                                        public boolean onLongClick(View v) {
                                            ...
                                            MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Mobile.this);
                                            View Mview = LayoutInflater.from(Mobile.this).inflate(R.layout.catagory_control, null, false);
