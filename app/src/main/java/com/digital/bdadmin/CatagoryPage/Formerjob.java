...
public class Formerjob extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.formerjob);
        ...
        DailyInstumentDatabase = FirebaseDatabase.getInstance().getReference().child(DataManager.FormerJob);
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Formerjob.this);
                View Mview = LayoutInflater.from(Formerjob.this).inflate(R.layout.input_subcatagory, null, false);
                ...
                insertbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (subcatagry.isEmpty()) {
                            ...
                            categorymap.put(DataManager.Type, DataManager.FormerJob);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    catagoryHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                                        ...
                                        public boolean onLongClick(View v) {
                                            ...
                                            MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Formerjob.this);
                                            View Mview = LayoutInflater.from(Formerjob.this).inflate(R.layout.catagory_control, null, false);
