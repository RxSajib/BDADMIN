...
public class Sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DailyInstumentDatabase = FirebaseDatabase.getInstance().getReference().child(DataManager.Sports);
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Sports.this);
                View Mview = LayoutInflater.from(Sports.this).inflate(R.layout.input_subcatagory, null, false);
                ...
                insertbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (subcatagry.isEmpty()) {
                            ...
                            categorymap.put(DataManager.Type, DataManager.Sports);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    catagoryHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                                        ...
                                        public boolean onLongClick(View v) {
                                            ...
                                            MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Sports.this);
                                            View Mview = LayoutInflater.from(Sports.this).inflate(R.layout.catagory_control, null, false);
