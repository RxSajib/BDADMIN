...
public class Vychel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vychel);
        ...
        DailyInstumentDatabase = FirebaseDatabase.getInstance().getReference().child(DataManager.Vecicle);
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Vychel.this);
                View Mview = LayoutInflater.from(Vychel.this).inflate(R.layout.input_subcatagory, null, false);
                ...
                insertbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (subcatagry.isEmpty()) {
                            ...
                            categorymap.put(DataManager.Type, DataManager.Vecicle);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    catagoryHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                                        ...
                                        public boolean onLongClick(View v) {
                                            ...
                                            MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Vychel.this);
                                            View Mview = LayoutInflater.from(Vychel.this).inflate(R.layout.catagory_control, null, false);
