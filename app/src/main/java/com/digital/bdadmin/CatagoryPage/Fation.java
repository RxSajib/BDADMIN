...
public class Fation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fation);
        ...
        DailyInstumentDatabase = FirebaseDatabase.getInstance().getReference().child(DataManager.Fation);
        ...
        addbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Fation.this);
                View Mview = LayoutInflater.from(Fation.this).inflate(R.layout.input_subcatagory, null, false);
                ...
                insertbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (subcatagry.isEmpty()) {
                            ...
                            categorymap.put(DataManager.Type, DataManager.Fation);
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    catagoryHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                                        ...
                                        public boolean onLongClick(View v) {
                                            ...
                                            MaterialAlertDialogBuilder Mbuilder = new MaterialAlertDialogBuilder(Fation.this);
                                            View Mview = LayoutInflater.from(Fation.this).inflate(R.layout.catagory_control, null, false);
